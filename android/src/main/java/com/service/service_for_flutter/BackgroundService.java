...
public class BackgroundService extends Service implements MethodChannel.MethodCallHandler {
    ...
    synchronized public static WakeLock getLock(Context context) {
        if (lockStatic == null) {
    ...
    public static void enqueue(Context context) {
        ...
        PendingIntent pIntent = PendingIntent.getBroadcast(context, 1112, intent, flags);
    ...
    public void setAutoStartOnBootMode(boolean value) {
        SharedPreferences pref = getSharedPreferences("id.flutter.service_for_flutter", MODE_PRIVATE);
    ...
    private void createNotificationChannel() {
        if (SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel channel = new NotificationChannel("FOREGROUND_DEFAULTS", name, importance);
    ...
    protected void updateNotificationInfo() {
        if (isForegroundService(this)) {
            ...
            PendingIntent pi = PendingIntent.getActivity(BackgroundService.this, 99777, i, flags);

            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, "FOREGROUND_DEFAULTS")
            ...
            startForeground(99777, mBuilder.build());
        }
    }
    ...
    private void runService() {
        try {
            ...
            methodChannel = new MethodChannel(backgroundEngine.getDartExecutor().getBinaryMessenger(), "id.flutter/service_for_flutter_android_bg", JSONMethodCodec.INSTANCE);
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull MethodChannel.Result result) {
        ...
        try {
            ...
            if (method.equalsIgnoreCase("stopService")) {
                ...
                PendingIntent pi = PendingIntent.getBroadcast(getApplicationContext(), 1112, intent, flags);
            ...
            if (method.equalsIgnoreCase("sendData")) {
                EventBus.getDefault().post(new MessageEvent(call.arguments.toString()));
//                LocalBroadcastManager manager = LocalBroadcastManager.getInstance(this);
//                Intent intent = new Intent("id.flutter/service_for_flutter");
